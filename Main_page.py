...
if selected == 'DashBoard':
    ...
    # Display the heatmap for crime incidents by district and age
    st.header("Heatmap for Crime Incidents by District and Age")
    ...
    with col1:
        # Display the profession distribution by city
        st.subheader("City wise Profession Distribution")
        ...
        st.plotly_chart(fig_city_profession, use_container_width=True)

    with col2:
        # Display the caste distribution by city
        st.subheader("City wise Caste Distribution")
        ...
        st.plotly_chart(fig_city_caste, use_container_width=True)
